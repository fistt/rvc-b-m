...
def get_index():
    if check_for_name() != '':
        if config.iscolab:
            ...
            logs_path="/content/EasyGUI-RVC-Fork/logs/"+chosen_model
...
def get_indexes():
    indexes_list=[]
    if config.iscolab:
        for dirpath, dirnames, filenames in os.walk("/content/EasyGUI-RVC-Fork/logs/"):
...
def match_index(speaker):
    ...
    parent_dir="/content/EasyGUI-RVC-Fork/logs/"+folder
    ...
    with gr.Tabs():
        ...
        with gr.TabItem("Download Model"):
            ...
            with gr.Row():
                gr.Markdown(
                """
                Original RVC:https://github.com/RVC-Project/EasyGUI-RVC-Fork
